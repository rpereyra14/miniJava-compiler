...
public class ASTDisplay implements Visitor<String,Object> {
  ...
  // Types
    ...
    public Object visitMethodType(MethodType type, String arg){
        show(arg, type);
        type.eltType.visit(this, indent(arg));
        return null;
    }    
    ...
    public Object visitForStmt(ForStmt stmt, String arg){
        ...
        stmt.cond.visit( this, indent(arg) );
        stmt.updt.visit( this, indent(arg) );
        stmt.body.visit( this, indent(arg) );
        return null;
  ...
  // References
    ...
    public Object visitLocalRef(LocalRef ref, String arg){
        show(arg, ref);
        ref.qualifier.visit( this, indent(arg) );
        return null;
    }
    ...
    public Object visitClassRef(ClassRef ref, String arg){
        show(arg, ref);
        ref.classid.visit( this, indent(arg) );
        return null;
    }
    ...
    public Object visitDeRef(DeRef ref, String arg){
        show(arg, ref);
        ref.left.visit( this, indent(arg) );
        ref.right.visit( this, indent(arg) );
        return null;
    }
